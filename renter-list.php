...
<html>
	...
	<body>
		...
		<div class='renter-list'>
			<div class='container'>
				<h2 style="color: #744700;">Renter List</h2>
				<a href='admin-home.php' class='btn custom-btn1'>Back</a>
				<a href='addRenter.php' class='btn custom-btn1'>Add Renter</a>
				...
				<ul class='list-group'>
					<?php
						...
						$query = "SELECT * FROM renter ORDER BY RenterID";
						$result = $conn->query($query);
						
						if($result->num_rows > 0) {
							while($row = $result->fetch_array(MYSQLI_ASSOC)) {
								echo <<<_END
										<li class='list-group-item list-group-item-active'><a href='renter-details.php?RenterID=$row[RenterID]'>RenterID: $row[RenterID] <br> First Name: $row[FirstName] <br> Last Name: $row[LastName]</a></li>
