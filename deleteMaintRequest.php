...
<html>
	<head>
		...
		<title>CPM: Delete Maintenance Request</title>
				...
				if (isset($_GET['MaintenanceID'])) {
					...
					if ($result->num_rows ==1) {
						while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
							echo <<<_END
							<form action='deleteMaintRequest.php?MaintenanceID=$maintenanceID' method='post'>
								<pre>
						...
						if (isset($_POST['delete'])) {
							...
							header("Location: maintenance-list.php");
						}
					}
