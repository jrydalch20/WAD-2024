...
<html>
	<head>
		...
		<title>CPM: Renters Details</title>
	...
	<body>
		...
		<div class='details-container'>
			<div class='container'>
				<h2 style="color: #744700;">Renter Details</h2>
				<a href='back.php?RenterID=<?php echo $renterID;?>' class='btn custom-btn1'>Back</a>
				<br><br>
				...
				// Check if RenterID is set in the URL
				if(isset($_GET['RenterID'])) {
					...
					if($result->num_rows > 0) {
						...
						echo <<<_END
								...
								<a href='updateRenter.php?RenterID=$renterID' class='btn custom-btn1'>Update Details</a>
								<a href='deleteRenter.php?RenterID=$renterID' class='btn custom-btn1'>Delete User</a>
							_END;
					} else {
